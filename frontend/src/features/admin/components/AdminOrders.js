            ...
            <table className="w-full table-auto">
              <thead>
                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                  ...
                  <th className="py-3 px-0 text-left">Sản phẩm</th>
                  <th
                  ...
                  <th className="py-3 px-0 text-center">Địa chỉ nhận hàng</th>
                  <th className="py-3 px-0 text-center">Trạng thái đặt hàng</th>
                  <th className="py-3 px-0 text-center">Phương thức thanh toán</th>
                  <th className="py-3 px-0 text-center">Trạng thái thanh toán</th>
                  <th
                    className="py-3 px-0 text-left cursor-pointer"
                    onClick={(e) =>
                      handleSort({
